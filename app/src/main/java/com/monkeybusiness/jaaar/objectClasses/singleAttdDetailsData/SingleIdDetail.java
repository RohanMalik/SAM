...
public class SingleIdDetail {
     ...
     * 
     * @return
     *     The studentAttendanceGroupId
     */
    public int getStudentAttendanceGroupId() {
        return studentAttendanceGroupId;
    }

    /**
     * 
     * @param studentAttendanceGroupId
     *     The student_attendance_group_id
     */
    public void setStudentAttendanceGroupId(int studentAttendanceGroupId) {
