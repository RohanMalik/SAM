...
import com.monkeybusiness.jaaar.Adapter.ExamsLectureAdapter;
...
public class MyClassExamsActivity extends BaseActivity {
    ...
    private void setUIData(LectureResponseData lectureResponseData) {
        ...
        if (!lectureResponseData.getData().getLectures().isEmpty())
        {
            ...
            examsLectureAdapter = new ExamsLectureAdapter(this,lectureResponseData);
            listViewLectures.setAdapter(examsLectureAdapter);
        }
    }
    ...
    public void lectureServerCall()
    {
        ...
        RestClient.getApiServicePojo(xCookies,aCookies).apiCallLectures(new Callback<LectureResponseData>() {
            ...
            public void success(LectureResponseData lectureResponseData, Response response) {
                ...
                Prefs.with(MyClassExamsActivity.this).save(PrefsKeys.LECTURE_RESPONSE_DATA,lectureResponseData);
